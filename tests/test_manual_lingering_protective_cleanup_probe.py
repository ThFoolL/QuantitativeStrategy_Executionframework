...
class ManualLingeringProtectiveCleanupProbeCase(unittest.TestCase):
    def test_module_imports(self) -> None:
        import exec_framework.manual_lingering_protective_cleanup_probe as probe
    ...
    def test_min_notional_bump(self) -> None:
        ...
        qty = probe._bump_quantity_to_min_notional(quantity=0.008, price=2300.0, qty_step=0.001, min_notional=20.0)
