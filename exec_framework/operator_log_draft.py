...
def build_operator_log_draft_struct(
    ...
    return {
        ...
        'operator_conclusion': {
            ...
            'allow_run': 'keep_frozen' if confirmation.should_freeze else 'allow',
    ...
    return '\n'.join(
        [
            ...
            *[f'- {item}' for item in facts],
            ...
            f"- discord_monitor_channel：`{((confirm_summary.get('discord_alert_preview') or {}).get('channel_id') or 'DISCORD_CHANNEL_ID_PLACEHOLDER')}`",
