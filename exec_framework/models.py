...
class LiveStateSnapshot:
    ...
    last_publishable_result: Dict[str, Any] = field(default_factory=dict)
    position_confirmation_level: str = 'NONE'
    trade_confirmation_level: str = 'NONE'
    needs_trade_reconciliation: bool = False
    fills_reconciled: bool = False
    last_confirmed_order_ids: List[str] = field(default_factory=list)
    protective_order_status: str = 'NONE'
    exchange_protective_orders: List[Dict[str, Any]] = field(default_factory=list)
    protective_order_last_sync_ts: Optional[str] = None
    protective_order_last_sync_action: Optional[str] = None
    protective_order_freeze_reason: Optional[str] = None
    protective_phase_status: str = 'NONE'
    strategy_protection_intent: Dict[str, Any] = field(default_factory=dict)
    async_operations: Dict[str, Any] = field(default_factory=dict)
    execution_retry_backoff: Dict[str, Any] = field(default_factory=dict)
    pending_execution_block_reason: Optional[str] = None
    recover_check: Dict[str, Any] = field(default_factory=dict)
    recover_timeline: List[Dict[str, Any]] = field(default_factory=list)
