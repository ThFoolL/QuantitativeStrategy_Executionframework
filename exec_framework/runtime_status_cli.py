...
def _to_live_state_snapshot(state: dict[str, Any] | None) -> LiveStateSnapshot:
    ...
    return LiveStateSnapshot(
        ...
        strategy_ref_entry_price=state.get('strategy_ref_entry_price'),
        strategy_ref_risk_per_unit=state.get('strategy_ref_risk_per_unit'),
        strategy_ref_base_quantity=state.get('strategy_ref_base_quantity'),
        strategy_ref_notional=state.get('strategy_ref_notional'),
        strategy_ref_risk_amount=state.get('strategy_ref_risk_amount'),
        execution_entry_price=state.get('execution_entry_price'),
        execution_risk_per_unit=state.get('execution_risk_per_unit'),
        execution_quantity=state.get('execution_quantity'),
        execution_notional=state.get('execution_notional'),
        execution_risk_amount=state.get('execution_risk_amount'),
        execution_high_water_r=float(state.get('execution_high_water_r') or 0.0),
...
def build_runtime_status_summary(
    *,
    ...
    position_summary = {
        ...
        'execution_notional': state.get('execution_notional'),
        'execution_risk_amount': state.get('execution_risk_amount'),
        'execution_high_water_r': state.get('execution_high_water_r'),
