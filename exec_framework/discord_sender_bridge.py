...
class MessageToolDiscordSender:
    ...
    def __init__(
        ...
        *,
        ...
        execution_confirmation_real_send_enabled: bool = False,
    ):
        self.channel = channel
        self.real_send_enabled = real_send_enabled
        self.message_tool_enabled = message_tool_enabled
        self.execution_confirmation_real_send_enabled = execution_confirmation_real_send_enabled
    ...
    def build_dispatch_preview(self, payload: DiscordMessagePayload) -> MessageToolDispatch:
        return MessageToolDispatch(
            ...
            metadata={
                ...
                'execution_confirmation_real_send_enabled': self.execution_confirmation_real_send_enabled,
    ...
    def build_send_gate(self, payload: DiscordMessagePayload) -> dict[str, Any]:
        ...
        if payload_kind == 'execution_confirmation' and not bool(getattr(self, 'execution_confirmation_real_send_enabled', False)):
        ...
        return {
            ...
            'transport_ready': transport_name not in {'unconfigured_transport'},
            'operator_open_summary': {
                'rehearsal_real_send': 'ready_to_open_by_env_only'
                if self.real_send_enabled and self.message_tool_enabled and transport_name not in {'unconfigured_transport'}
                else 'closed_or_blocked',
                'execution_confirmation_real_send': 'ready_to_open_by_env_only'
                if self.real_send_enabled and self.message_tool_enabled and self.execution_confirmation_real_send_enabled and transport_name not in {'unconfigured_transport'}
                else 'closed_or_blocked',
            },
